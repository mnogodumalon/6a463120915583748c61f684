...
const BEWERBUNGEN_FIELDS = [
  ...
  { key: 'eingangsdatum', label: 'Eingangsdatum', type: 'date/date' },
  { key: 'phase', label: 'Phase', type: 'lookup/select', options: [{ key: 'eingegangen', label: 'Eingegangen' }, { key: 'screening', label: 'Screening' }, { key: 'gespraech_1', label: '1. Gespräch' }, { key: 'gespraech_2', label: '2. Gespräch' }, { key: 'angebot', label: 'Angebot' }, { key: 'abgelehnt', label: 'Abgelehnt' }] },
  { key: 'quelle', label: 'Bewerbungsquelle', type: 'lookup/select', options: [{ key: 'eigene_website', label: 'Eigene Website' }, { key: 'linkedin', label: 'LinkedIn' }, { key: 'xing', label: 'XING' }, { key: 'indeed', label: 'Indeed' }, { key: 'stepstone', label: 'StepStone' }, { key: 'empfehlung', label: 'Empfehlung' }, { key: 'initiativ', label: 'Initiativbewerbung' }, { key: 'sonstige', label: 'Sonstige' }] },
  { key: 'bewerbungsunterlagen', label: 'Bewerbungsunterlagen', type: 'file' },
...
const STELLEN_FIELDS = [
  ...
  { key: 'status', label: 'Status der Stelle', type: 'lookup/radio', options: [{ key: 'offen', label: 'Offen' }, { key: 'besetzt', label: 'Besetzt' }, { key: 'pausiert', label: 'Pausiert' }] },
  { key: 'beschreibung', label: 'Stellenbeschreibung / Anforderungen', type: 'string/textarea' },
];
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<EntityKey>('bewerbungen');
