...
const PROXY_BASE = '';
const APP_ID = '6a46310b1bb742915f83d735';
      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="phase" className="max-sm:h-11"><SelectValue placeholder="" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="quelle" className="max-sm:h-11"><SelectValue placeholder="" /></SelectTrigger>
              <SelectContent>
                <SelectItem value="none">—</SelectItem>
