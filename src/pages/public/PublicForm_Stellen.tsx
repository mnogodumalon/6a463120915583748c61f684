...
const PROXY_BASE = '';
const APP_ID = '6a463108ce8058178b7c0823';
      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 shadow-md">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="beschaeftigungsart" className="max-sm:h-11"><SelectValue placeholder="" /></SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="status">Status der Stelle *</Label>
